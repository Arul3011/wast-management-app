...
function About() {
  return (
    <div className="w-full bg-[#bbe4bb] py-[20px]" id="about">
      ...
      <p className="text-center text-[30px] py-[20px] w-[60%] mx-auto">
        Waste Trade is the pioneering online marketplace that connects waste generators, such as manufacturers, with recyclers and end users of waste commodities around the globe.
      </p>
    </div>
  );
}
